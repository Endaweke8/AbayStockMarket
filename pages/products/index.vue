          ...
          <div style="position: sticky; top: 92px">
            ...
            <v-list-item-content>
                  <v-list-item-title  class="mb-3">
                     <nuxt-link class="linkk"  to="/closes">Clothes</nuxt-link>
                  </v-list-item-title>
                   <v-list-item-title class="mb-3" >
                    <nuxt-link class="linkk" to="/shoes">Shoes</nuxt-link>
                  </v-list-item-title>
                   <v-list-item-title  class="mb-3">
                     <nuxt-link class="linkk" to="/perfumes">Perfumes</nuxt-link>
                  </v-list-item-title>
                   <v-list-item-title  class="mb-3">
                    <nuxt-link  class="linkk" to="/bages">Bags</nuxt-link>
                  </v-list-item-title>
                   <v-list-item-title  class="mb-3">
                   <nuxt-link class="linkk" to="/foods">Foods</nuxt-link>
                  </v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-list>
